...
export type FeedQuery = { __typename?: 'Query', feed: { __typename?: 'Feed', feedId: string, inputUrl: string, imageUrl?: string | null, title?: string | null, description?: string | null, feedUrl?: string | null, link?: string | null, subscribed: boolean, articles: Array<(
      { __typename?: 'Article' }
...
export type MyFeedsMutation = { __typename?: 'Mutation', myFeeds: Array<{ __typename?: 'Feed', feedId: string, imageUrl?: string | null, title?: string | null, articles: Array<(
      { __typename?: 'Article' }
      & { ' $fragmentRefs'?: { 'ArticlePreviewFieldsFragment': ArticlePreviewFieldsFragment } }
    )> }> };
